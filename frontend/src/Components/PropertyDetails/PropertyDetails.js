...
const PropertyDetails = () => {
    ...
    const {propertyName,address,images,description,maximumGuest,amenities
    ,price,currentBookings,extraInfo}=propertydetails;
  return (
    <div className="property-container">
        {
            ...
            <div className="middle-container row">
              <div className="des-and-amenities col-md-8 col-sm-12 col-12">
                ...
                <br/><br/>Max number of Guests: {maximumGuest}<br/><br/></p>
                <hr/>
            ...
            <div className="property-map">
              <div className="map-imaage-exinfo-container row">
