...
import PropTypes from "prop-types"; //for prop checking prop
...
const FilterModal = ({selectedFilters,onFilterChange,onClose}) => {
    ...
    const [propertyType, setPropertyType]=useState(
        selectedFilters.propertyType ||"" //default it is empty or the selected property
    );
  ...
  //function to handle applyling filters
  ...
  const propertyTypeOptions =[
    ...
    { value: "Flat", label:"Flat",icon:"appartment"},
    {
      value: "Guest House",
      label:"Guest House",
      icon:"hotel",
  ...
  //function to handle changes n amenities
